                ...
                <div class="dash-item">
                    <a href="{{ route('admin.users.userIndex') }}">
                        <div class="dash-item-icon">
                            <img src="{{ asset('assets/images/total-children.svg') }}">
                        </div>
                        <div>
                            <h6>Total Verifiers</h6>
                            <p class="mb-0">{{ $userCount ?? 0 }}</p>
                        </div>
                    </a>
                </div>
            </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($activity->checkedBy)
                                                        {{ $activity->checkedBy->first_name }} {{ $activity->checkedBy->last_name }}
                                                    @else
                                                        —
                                                    @endif
                                                </td>
                            ...
                            @foreach ($projectProgress as $row)
                                <div class="mb-3">
                                    <div class="d-flex justify-content-between align-items-center mb-1">
                                        <span class="fw-medium text-truncate me-2" style="max-width:220px"
