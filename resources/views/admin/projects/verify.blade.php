    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-title-row d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
            <div>
                ...
                <p class="text-muted small ms-3 mb-0 mt-1">
                    ...
                    @if($project->client_name) &nbsp;&bull;&nbsp;{{ $project->client_name }} @endif
                </p>
            </div>
        ...
        <div class="whiteBg mb-3">
            <div class="row g-3">
                <div class="col-md-3">
                    ...
                    <p class="fw-semibold mb-0">{{ $project->project_name }}</p>
                </div>
                <div class="col-md-3">
        ...
        @if($total === 0)
            <div class="whiteBg text-center py-5">
                ...
                <p class="text-muted mb-3">No checklist items have been assigned to this project yet.</p>
                <a href="{{ enroute('admin.project.checklist', $project->id) }}" class="btn btn-primary">
        ...
        <form id="verifyForm"
            data-action="{{ enroute('admin.project.verify.save', $project->id) }}"
            ...
            <div class="whiteBg mb-3">
                ...
                <textarea name="deployment_notes" class="form-control" rows="4"
                    placeholder="Add deployment notes, sign-off comments, or observations...">{{ $project->deployment_notes }}</textarea>
                <div class="form-text">Notes are visible in the project report.</div>
            </div>
