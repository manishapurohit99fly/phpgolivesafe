...
@section('admin-title', 'Verify Checklist')
        ...
        <form id="verifyForm"
            ...
            <div class="whiteBg mb-3">
                ...
                <textarea name="deployment_notes" class="form-control" rows="4"
                    placeholder="Add deployment notes, observations, or sign-off comments...">{{ $project->deployment_notes }}</textarea>
                <div class="form-text">These notes are visible in the project report.</div>
            </div>
