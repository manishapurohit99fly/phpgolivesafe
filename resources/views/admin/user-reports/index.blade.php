...
@section('admin-title', 'My Project Reports')
...
<div class="container-fluid pt-3 bg">
    <div class="page-content-wrapper">
        ...
        <div class="page-title-row justify-content-between mb-3">
            <h4 class="mb-0 ms-3"><i class="fa fa-chart-bar me-2"></i>My Project Reports</h4>
        </div>
        ...
        <div id="reportContainer">
            <div class="text-center py-5">
                ...
                <p class="text-muted">Select one of your assigned projects above to view its report.</p>
            </div>
        </div>
...
<script>
(function () {
    var loadUrl   = '{{ route("user.reports.load") }}';
    ...
    $select.on('change', function () {
        ...
        if (val) {
            ...
            $container.html(
                '<div class="text-center py-5"><i class="fa fa-chart-bar fa-3x text-muted d-block mb-3 opacity-25"></i><p class="text-muted">Select one of your assigned projects above to view its report.</p></div>'
            );
        }
    });

    // Auto-load if navigated here with a project_id (e.g. from My Projects Report button)
    if (preselect) {
