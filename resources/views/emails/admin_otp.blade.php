            ...
            <tr>
                <td style="padding:0px;" bgcolor="#ffffff">
                    ...
                    <table
                        ...
                        <tr>
                            <td style="background:#1A1817; color: #fff; text-align:center; padding:20px 0;">
                        ...
                        <tr>
                            <td
                                ...
                                <p style="line-height: 28px;margin: 0 0 20px 0;color: #000000;">
                                    Hello <strong>{{ ucfirst($first_name) }}</strong>,
                                </p>

                                <p>Use the following code to verify your identity and complete your admin login. This
                                    code is valid for 10 minutes.</p>

                                <br>
                                <p><span
                                        style="margin-bottom: 20px; background: #060c08; padding: 10px 20px; color: #fff; font-size: 14px; font-weight: bold; text-decoration: none;">
                                        {{ $otp }}
                                    </span></p>
