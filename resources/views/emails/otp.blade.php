                    ...
                    <table
                        ...
                        <tr>
                            <td
                                ...
                                <img src="{{asset('assets/img/logo.png')}}" alt="logo" style="width: 70px;" width="70px">
                            </td>
                        </tr>
                        <tr>
                            <td
                                ...
                                <p>Thank you for choosing {{ config('app.name') }}. Use the following OTP to complete your
                                    registration procedures. OTP is valid for 10 minutes</p>
                                <br>
                                <p style="margin-bottom: 20px;">
                                    <a href="javascript:void(0)"
                                        style="background: #3cbf5f; padding: 10px 20px; color: #fff; font-size: 14px; font-weight: bold; text-decoration: none; ">{{ $otp }}</a>
                                </p>
                                <br>

                                <p style="margin: 0">We look forward to meeting you.</p>
                                <p style="line-height: 28px;margin: 0 0 20px 0;">
                                    <strong>{{ config('app.name') }} App,</strong><br />
                                </p>
                            </td>
                        </tr>
                    </table>
